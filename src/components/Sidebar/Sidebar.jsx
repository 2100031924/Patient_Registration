...
import { FiUser, FiFileText, FiHeart, FiShield, FiFolder, FiCheckCircle, FiClock, FiCheck, FiX } from "react-icons/fi";
import { useFormContext, steps } from "../../context/FormContext";
import "./Sidebar.css";

const iconMap = {
  "Personal Details": FiUser,
  "Personal Information": FiUser,
        ...
        <div className="sidebar-footer">
          <div className="profile-progress-card">
            ...
            <div className="progress-bar-track">
              <div className="progress-bar-fill" style={{ width: `${activeStepMeta.percentage}%` }} />
            </div>
            <div className="estimated-time">
              <FiClock className="time-icon" />
              <span>Estimated Time: {activeStepMeta.time || "2-3 Minutes"}</span>
            </div>
          </div>
        </div>
      </aside>
